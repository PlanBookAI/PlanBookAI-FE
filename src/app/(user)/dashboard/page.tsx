                ...
                <HeroSidebarSection title="Thao tác nhanh">
                  <div className="space-y-2">
                    ...
                    <HeroSidebarAction
                      ...
                      badge="AI"
                      href="/ai/lesson-plans"
                    />
                  </div>
                </HeroSidebarSection>

                {/* Recent Stats */}
                <HeroSidebarSection title="Hoạt động tuần này">
                  <HeroSidebarStats stats={[
                    {
                      label: "Giáo án tạo",
                    ...
                    },
                    {
                      ...
                      value: `${stats.totalLessonPlans}/${stats.monthlyGoal}`,
                      icon: (
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                <Link href="/lesson-plans" className="block">
                ...
                <Link href="/ai/lesson-plans" className="block">
                  <Button variant="ghost" className="w-full justify-start">
                    <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                    </svg>
