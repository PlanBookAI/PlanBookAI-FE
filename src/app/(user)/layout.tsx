            ...
            <div className="space-y-1">
              ...
              <div className="border-t pt-4 mt-6">
                ...
                <div className="flex items-center space-x-2 px-3 py-2 text-sm text-gray-600 bg-blue-50 rounded-lg">
                  ...
                  <span className="font-medium">Hóa học THPT</span>
                  <span className="ml-auto text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded">Active</span>
                </div>
              </div>
